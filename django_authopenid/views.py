...
from snippify.django_authopenid.forms import *
from snippify.django_authopenid.models import UserAssociation
from snippify.django_authopenid.models import UserProfile
from snippify.django_authopenid.signals import oid_register
from snippify.django_authopenid.utils import *
...
def register(request, template_name='authopenid/complete.html',
            ...
            register_account=register_account, send_email=False,
            extra_context=None):
    """
    register an openid.
